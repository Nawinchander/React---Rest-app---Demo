...
const work = () => {
    ...
    const workInfoData = [
        ...
        },
        {
            ...
            text: 'We prioritize speedy deliveries,From kitchen to your table in record time, our commitment to swift service means youll never have to wait long for your delicious meal to arrive.'
        }
    ]
} 
  return (
